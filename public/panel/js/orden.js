...
/***/ "./resources/js/panel/orden/Orden.js":
/*!*******************************************!*\
  !*** ./resources/js/panel/orden/Orden.js ***!
  \*******************************************/
...
var Orden = /*#__PURE__*/function () {
  function Orden(path, eventos, cupones) {
  ...
  _createClass(Orden, [{
    key: "getPrecios",
    value: function () {
      var _getPrecios = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
        var response;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(this.path + 'admin/ventas/' + id + '/precios');
            case 2:
      ...
      function getPrecios(_x) {
        return _getPrecios.apply(this, arguments);
      }
      return getPrecios;
    }()
  }, {
    key: "setListaPrecios",
    value: function setListaPrecios(precios) {
      this.listaPrecios = precios;
    }
  }, {
    key: "getPrecioPorPersona",
    value: function getPrecioPorPersona(id) {
      return _.find(this.listaPrecios, function (precio) {
        return precio.id == id;
      });
    }
  }, {
    key: "getEvento",
    value: function getEvento(id) {
      return _.find(this.eventos, function (evento) {
        return evento.id == id;
      });
    }
  }, {
    ...
    key: "getCupon",
    value: function getCupon(id) {
      return _.find(this.cupones, function (cupon) {
        return cupon.id == id;
      });
    }
  }]);
...
/***/ "./resources/js/panel/orden/index.js":
/*!*******************************************!*\
  !*** ./resources/js/panel/orden/index.js ***!
  \*******************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Orden__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Orden */ "./resources/js/panel/orden/Orden.js");
...
var orden = new _Orden__WEBPACK_IMPORTED_MODULE_0__["Orden"](PATH, EVENTOS, CUPONES);
var dt = luxon__WEBPACK_IMPORTED_MODULE_1__["DateTime"].now();
var selectPersonas = document.getElementById('personas');
var wrapperPersonasCustom = document.getElementById('personasCustom');
var inputPrecio = document.getElementById('precio');
var inputPersonasCustom = document.getElementById('personas_custom');
var inputFecha = document.getElementById('fecha');
var inputHorario = document.getElementById('horario');
function getPreciosEventos(_x) {
  return _getPreciosEventos.apply(this, arguments);
}
function _getPreciosEventos() {
  _getPreciosEventos = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ev) {
    var eventoID, response, preciosxPersona, _HTML;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          eventoID = this.value;
        ...
        case 3:
          _context.next = 5;
          return orden.getPrecios(eventoID);
        case 5:
          response = _context.sent;
          preciosxPersona = response.data;
          orden.setListaPrecios(preciosxPersona);
          definirFechasHorario(eventoID);
          selectPersonas.innerHTML = '';
          _HTML = '';
          _.forEach(preciosxPersona, function (precio) {
...
function definirFechasHorario(eventoID) {
  var instance_fl = inputFecha._flatpickr;
  var evento = orden.getEvento(eventoID);
  ...
  instance_fl.config.onChange.push(function (selectedDates, dateStr, instance) {
    getInfoParaResumen();
  });
  inputHorario.value = evento.horario;
  if (evento.horario_fijo === 0) {
    var time = orden.addHours(new Date(), parseInt(evento.tiempo_espera));
...
function getInfoParaResumen() {
  ...
  var precioID = selectPersonas.value;
  var evento = eventoID ? orden.getEvento(eventoID) : {};
  var objPrecio, personas, precio;
  var instance_fl = inputFecha._flatpickr;
  if (precioID !== 'custom') {
  ...
  var fecha = instance_fl.altInput.value || '--';
  var horario = inputHorario.value || '--';
...
function getPrecioPorPersona() {
  ...
  var precio = orden.getPrecioPorPersona(precioID);
...
/***/ 2:
/*!*************************************************!*\
  !*** multi ./resources/js/panel/orden/index.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\Equipo 1\Documents\proyectos\amate_reingenieria_5.8\resources\js\panel\orden\index.js */"./resources/js/panel/orden/index.js");
