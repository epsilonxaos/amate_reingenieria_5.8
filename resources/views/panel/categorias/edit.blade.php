                                ...
                                <div class="row">
                                    @if (request('seccion') === 'experiencias')
                                        ...
                                        <div class="col-12 col-md-6 mb-4">
                                            ...
                                            <input type="file" name="cover_en" class="dropify" data-height="300" data-max-file-size="2M" data-default-file="{{asset($data -> cover_en)}}" data-allowed-file-extensions="jpg jpeg png" />
                                            <small>Las medidas recomendadas son 670 x 396 px, solo se aceptan .jpg, .jpeg y .png con un maximo de peso de 2MB.</small>
