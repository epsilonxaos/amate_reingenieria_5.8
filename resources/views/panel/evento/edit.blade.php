...
@section('content')
    ...
    <div class="container-fluid mt--6">
        <div class="row">
            <div class="col">
                <form action="{{route('panel.evento.update', ['id' => $data -> id])}}" method="POST" enctype="multipart/form-data" class="form-submit-alert-wait">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-12 col-sm-6"><h3>Editar experiencia</h3></div>
                                <div class="col-12 col-sm-6 text-center text-sm-right">
                                    <a href="{{route('panel.evento.galeria.acciones', ['accion' => 'edit', 'id' => $data -> id])}}" class="btn btn-default pt-2 pb-2"><i class="fas fa-images mr-2"></i> Editar galería</a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-2 mb-4">
                                                        ...
                                                        <label class="custom-toggle">
                                                            <input type="checkbox" {{$data -> horario_fijo === 1 ? 'checked' : ''}} value="{{$data -> horario_fijo === 1 ? true : false}}"  id="horario_fijo" name="horario_fijo" onchange="toggle()">
                                                            <span class="custom-toggle-slider rounded-circle" data-label-off="No" data-label-on="Si"></span>
                                                        </label>
                                                    </div>
                
                                                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                                                        <label for="horario" class="form-control-label">Horario experiencia</label>
                                                        <input class="form-control" type="time" name="horario" value="{{$data -> horario}}" id="horario">
                                                    </div>
                                                    ...
                                                    <div class="col-12 col-sm-6 col-md-4 mb-4">
                                                        ...
                                                        <div class="d-flex items-align-start justify-content-start">
                                                            <article class="card-radio" style="height: 80px; justify-content: flex-end; padding-bottom: 15px;">
                                                                <input type="radio" name="tiempo_espera" value="24" {{$data -> tiempo_espera == '24' ? 'checked="checked"' : ''}} />
                                                                <span class="checkmark"></span>
                                                                <span class="label"> 24 hrs</span>
                                                                <section class="decoration-card" style="height: 80px;"></section>
                                                            </article>
                                                            <article class="card-radio" style="height: 80px; justify-content: flex-end; padding-bottom: 15px;">
                                                                <input type="radio" name="tiempo_espera" value="48" {{$data -> tiempo_espera == '48' ? 'checked="checked"' : ''}} />
                                                                <span class="checkmark"></span>
                                                            ...
                                                            <div class="d-flex items-align-start justify-content-start">
                                                                @foreach ($categorias as $item)
                                                                    <article class="card-radio">
                                                                        <input type="radio" name="categorias_id" value="{{$item -> id}}" {{$data -> categorias_id == $item -> id ? 'checked="checked"' : ''}} />
                                                                        <span class="checkmark"></span>
                                                                        <span class="price">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12 mb-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="title" value="{{(old('title')) ? old('title') :  $data -> title}}" required>
                                                                                    @if($errors -> has('title'))
                                                                            ...
                                                                            <div class="col-12 mb-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea class="form-control" name="short_description" rows="6" style="resize: none" onKeyDown="limitText(this.form.short_description, 150, '.limitText_short_description');" onKeyUp="limitText(this.form.short_description, 150, '.limitText_short_description');" maxlength="150">{{(old('short_description')) ? old('short_description') :  $data -> short_description}}</textarea>
                                                                                    <small>Caracteres disponibles: <span class="limitText_short_description text-primary font-weight-bold">{{150 - strlen(old('short_description') ? old('short_description') :  $data -> short_description)}}</span></small>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 mb-4">
                                                                                ...
                                                                                <textarea name="content" class="trumbowyg-panel" cols="30" rows="10">{{(old('content')) ? old('content') : $data -> content}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    {{-- Ingles --}}
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-12 mb-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text" class="form-control" name="title_en" value="{{(old('title_en')) ? old('title_en') :  $data -> title_en}}" required>
                                                                            ...
                                                                            <div class="col-12 mb-4">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <small class="pb-2 d-block">Breve descripción o introducción sobre la experiencia</small>
                                                                                    <textarea class="form-control" name="short_description_en" rows="6" style="resize: none" onKeyDown="limitText(this.form.short_description_en, 150, '.limitText_short_description_en');" onKeyUp="limitText(this.form.short_description_en, 150, '.limitText_short_description_en');" maxlength="150">{{(old('short_description_en')) ? old('short_description_en') :  $data -> short_description_en}}</textarea>
                                                                                    <small>Caracteres disponibles: <span class="limitText_short_description_en text-primary font-weight-bold">{{150 - strlen(old('short_description_en') ? old('short_description_en') :  $data -> short_description_en)}}</span></small>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12 mb-4">
                                                                                <label for="">Contenido</label>
                                                                                <small class="pb-2 d-block">Recomendamos siempre que al copiar y pegar información desde algun sitio o archivo <b>eliminar el formato</b> de los textos para un optimo funcionamiento, esto se puede realizar desde el mismo editor de texto presionando el siguiente botón <img src="{{asset('panel/img/clear-format.png')}}" alt="Clear format"></small>
                                                                                <textarea name="content_en" class="trumbowyg-panel" cols="30" rows="10">{{(old('descripcion_en')) ? old('descripcion_en') : $data -> descripcion_en}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <div class="card card-body shadow">
                                                            <div class="row">
                                                                <div class="col-12 col-md-4 mb-4">
                                                                    ...
                                                                    <input type="file" name="img_lateral_1" class="dropify" data-height="200" data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png" data-default-file="{{asset($data -> img_lateral_1)}}" />
                                                                    <small>Las medidas recomendadas son 670 x 396 px, solo se aceptan .jpg, .jpeg y .png con un maximo de peso de 2MB.</small>
                                                                </div>
                                                                <div class="col-12 col-md-4 mb-4">
                                                                    <label for="img_lateral_2">Imagen lateral #2 <span class="text-danger">*</span></label>
                                                                    <input type="file" name="img_lateral_2" class="dropify" data-height="200" data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png" data-default-file="{{asset($data -> img_lateral_2)}}" />
                                                                    <small>Las medidas recomendadas son 670 x 396 px, solo se aceptan .jpg, .jpeg y .png con un maximo de peso de 2MB.</small>
                                                                </div>
                                                                <div class="col-12 col-md-4 mb-4">
                                                                    <label for="img_lateral_3">Imagen lateral #3 <span class="text-danger">*</span></label>
                                                                    <input type="file" name="img_lateral_3" class="dropify" data-height="200" data-max-file-size="2M" data-allowed-file-extensions="jpg jpeg png" data-default-file="{{asset($data -> img_lateral_3)}}" />
                                                                    <small>Las medidas recomendadas son 670 x 396 px, solo se aceptan .jpg, .jpeg y .png con un maximo de peso de 2MB.</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="tab-pane fade" id="precios" role="tabpanel" aria-labelledby="precios-tab">
                                                ...
                                                <div id="listadoPrecios">
                                                    @foreach ($precios as $precio)
                                                        <div class="row personas_{{$precio -> id}}">
                                                            <div class="col-12 col-sm-1">
                                                                <button type="button" class="btn btn-danger btn-sm" onclick="removePrecio('.personas_{{$precio -> id}}')" title="Eliminar"><i class="fas fa-trash-alt"></i></button>
                                                            </div>
                                                            <div class="form-group col-12 col-sm-5">
                                                                <label for="personas_{{$precio -> id}}" class="form-control-label"># Personas</label>
                                                                <input class="form-control" type="number" min="1" name="personas[]" id="personas_{{$precio -> id}}" required value="{{$precio -> personas}}">
                                                            </div>
                                                            <div class="form-group col-12 col-sm-6">
                                                                <label for="precio_{{$precio -> id}}" class="form-control-label">Precio</label>
                                                                <input class="form-control" type="text" placeholder="Ejemplo: 12000.00" name="precio[]" id="precio_{{$precio -> id}}" required value="{{$precio -> precio}}">
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
